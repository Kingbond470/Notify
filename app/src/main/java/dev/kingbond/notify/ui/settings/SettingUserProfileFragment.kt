 ...
 * Use the [SettingUserProfileFragment.newInstance] factory method to
...
class SettingUserProfileFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SettingUserProfileFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SettingUserProfileFragment().apply {
